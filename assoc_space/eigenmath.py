...
def combine_dissimilar_eigenspaces(U_X, S_X, U_Y, S_Y, rank):
    '''
    Given the eigenvalue decompositions of X and Y, find that of (X + Y).  The
    result is trimmed to the specified rank.

    Returns: U, S.

    The algorithm is adapted from Brand 2006 (MERL TR2006-059), section 2, to
    operate on eigenvalue decompositions instead of SVDs.
    '''
    # Equation numbers referenced below are from Andrew's "Mitsubishi Magic".
